...
public class PoptartCoreArmorMaterials {
    ...
    public static final Holder<ArmorMaterial> MINING_ARMOR_MATERIAL = register(
            "mining", protection(2, 0, 0, 0), 1, ARMOR_EQUIP_IRON, 1.0F, 0.0F, () -> Ingredient.of(IRON_INGOT));
