...
public class PoptartCoreItems {
    ...
    public static final DeferredItem<RawHideArmorItem> RAW_HIDE_HELMET = ITEMS.register(
            "raw_hide_helmet",
            () -> new RawHideArmorItem(ArmorItem.Type.HELMET, new Item.Properties().durability(140)));
    public static final DeferredItem<RawHideArmorItem> RAW_HIDE_CHESTPLATE = ITEMS.register(
            "raw_hide_chestplate",
            () -> new RawHideArmorItem(ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(140)));
