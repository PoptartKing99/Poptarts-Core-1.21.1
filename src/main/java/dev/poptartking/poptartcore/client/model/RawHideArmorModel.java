                ...
                (mesh,
                    ...
                    head.addOrReplaceChild(
                            ...
                            CubeListBuilder.create()
                                    .texOffs(0, 0)
                                    .addBox(-4.5F, -8.5F, -4.5F, 9.0F, 10.0F, 9.0F, new CubeDeformation(0.1F)),
                            PartPose.ZERO);
                    ...
                    body.addOrReplaceChild(
                            ...
                            CubeListBuilder.create()
                                    .texOffs(0, 29)
                                    .addBox(-4.5F, -0.5F, -2.5F, 9.0F, 16.0F, 5.0F, new CubeDeformation(0.25F)),
                            PartPose.ZERO);
                    ...
                    PartDefinition belt = leggings.addOrReplaceChild(
                            ...
                            CubeListBuilder.create()
                                    .texOffs(36, 0)
                                    .addBox(-4.5F, 8.5F, -2.5F, 9.0F, 4.0F, 5.0F, CubeDeformation.NONE),
                            PartPose.ZERO);
                    ...
                    belt.addOrReplaceChild(
                            ...
                            CubeListBuilder.create()
                                    .texOffs(41, 9)
                                    .addBox(-4.5F, 0.0F, 0.0F, 9.0F, 5.0F, 0.0F, CubeDeformation.NONE),
                    ...
                    right_legging.addOrReplaceChild(
                            ...
                            CubeListBuilder.create()
                                    .texOffs(32, 48)
                                    .addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.333F)),
                            PartPose.ZERO);
                    ...
                    left_legging.addOrReplaceChild(
                            ...
                            CubeListBuilder.create()
                                    .texOffs(48, 48)
                                    .addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.33F)),
                            PartPose.ZERO);
