...
public class PoptartCoreModelLayers {
    ...
    public static PoptartCoreArmorModel LEATHER_TUNIC_MODEL;
    ...
    public static final ModelLayerLocation LEATHER_TUNIC_LAYER = new ModelLayerLocation(PoptartCore.location("leather_tunic"), "main");
