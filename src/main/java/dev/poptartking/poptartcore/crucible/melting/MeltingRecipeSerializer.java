...
public class MeltingRecipeSerializer implements RecipeSerializer<MeltingRecipe> {
    ...
    public MeltingRecipeSerializer(boolean blastFurnace) {
        this.codec = RecordCodecBuilder.mapCodec(instance -> instance.group(
                        ...
                        Codec.INT.fieldOf("duration").forGetter(MeltingRecipe::duration),
                        FluidStack.CODEC.fieldOf("result").forGetter(MeltingRecipe::result))
                .apply(
                        instance,
                        (ingredient, duration, result) ->
                                new MeltingRecipe(ingredient, duration, result, blastFurnace)));
        ...
        this.streamCodec = StreamCodec.composite(
                ...
                (ingredient, duration, result) -> new MeltingRecipe(ingredient, duration, result, blastFurnace));
    }
