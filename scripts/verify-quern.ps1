...
$required = @(
    ...
    "src\main\java\dev\poptartking\poptartcore\quern\QuernRenderer.java",
    "src\main\java\dev\poptartking\poptartcore\quern\QuernSoundInstance.java",
    "src\main\java\dev\poptartking\poptartcore\client\QuernHighlightRenderer.java",
    "src\main\java\dev\poptartking\poptartcore\quern\GrindingRecipe.java",
    ...
    "src\main\resources\assets\poptartcore\models\block\quern_stone_base.json",
    "src\main\resources\assets\poptartcore\models\block\quern_stone.json",
    "src\main\resources\assets\poptartcore\models\block\quern_flour.json",
    "src\main\resources\assets\poptartcore\models\block\quern_inventory.json",
    ...
    "src\main\resources\data\poptartcore\recipe\grinding\flour.json",
...
$base = Get-Content -Raw -LiteralPath (Join-Path $projectRoot "src\main\resources\assets\poptartcore\models\block\quern_stone_base.json") | ConvertFrom-Json
$rotor = Get-Content -Raw -LiteralPath (Join-Path $projectRoot "src\main\resources\assets\poptartcore\models\block\quern_stone.json") | ConvertFrom-Json
$flour = Get-Content -Raw -LiteralPath (Join-Path $projectRoot "src\main\resources\assets\poptartcore\models\block\quern_flour.json") | ConvertFrom-Json
...
if ($flour.elements[0].from[1] -ne 2.99) { throw "Flour layer must begin at Y=2.99" }
...
$recipe = Get-Content -Raw -LiteralPath (Join-Path $projectRoot "src\main\resources\data\poptartcore\recipe\grinding\flour.json") | ConvertFrom-Json
...
$redDyeRecipePath = Join-Path $projectRoot "src/main/resources/data/poptartcore/recipe/grinding/red_dye.json"
...
$flowerRecipes = @{
    "red_dye.json" = @("minecraft:poppy", "minecraft:red_dye", 1)
